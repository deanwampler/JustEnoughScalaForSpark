...
This tutorial uses a Docker image with Jupyter and Spark, for a much more robust, easy to use, and "industry standard" experience. There is also an option to use a BeakerX image (http://beakerx.com).
